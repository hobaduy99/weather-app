...
import { WeatherProps, ForecastData } from "../common/weatherTypes";
      ...
      function getCurrentPosition(): void {
        if ("geolocation" in navigator) {
          navigator.geolocation.getCurrentPosition(
            ...
            (error) => {
              toast.error("Error getting position. Please try again!");
              console.error("Error getting position:", error.message);
            }
          );
        } else {
          toast.error(
            "Geolocation is not supported by this browser. Please try again!"
          );
        ...
        <>
          ...
          {isHomePage ? (
            <>
              ...
              {forecast.length > 0 && <ForecastList forecastData={forecast} />}
